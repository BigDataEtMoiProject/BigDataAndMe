...
public class UsageFragment extends Fragment implements IUsageContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedBundle) {
        ...
        if(Build.VERSION.SDK_INT >= 21) {
            view = inflater.inflate(R.layout.fragment_donnees_utilisation, container, false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getActivity().getMenuInflater().inflate(R.menu.menu_data_usage, menu);
        return true;
    }
    ...
    public void setLayoutAndData() {
        ...
        statsManager = (UsageStatsManager) getActivity().getSystemService(Context.USAGE_STATS_SERVICE);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            case 0:
                                ...
                                //transaction.replace(R.id.UsageFragment, R.id.UsageTimelineFragment);
                                break;
                            case 1:
